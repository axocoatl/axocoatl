...
mod tests {
    ...
    fn workbench_retains_cross_tab_runtime_lifecycle_and_reconnect_gates() {
        for contract in [
            ...
            "reconcileSessionEnvironmentLifecycle(sessionId, {\n    invalidatesRuntime: true,\n    retireCockpitState,\n  });",
